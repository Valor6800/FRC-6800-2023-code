...
{ 
    ...
    posMap[Piece::CONE][Direction::FRONT][Position::GROUND_TOPPLE] =frc::Pose2d(0.1676_m, 0.0846_m, 108.11_deg);
    ...
    posMap[Piece::CONE][Direction::BACK][Position::PLAYER] =frc::Pose2d(-0.8605_m, 1.5625_m, 40.7_deg);
